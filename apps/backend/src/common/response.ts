import type { GameMessageType } from '@liar/message-types';
import type { LobbyMessageType } from '@liar/message-types';
 ...
 */
export function buildStatePayload<T>(messageType: GameMessageType | LobbyMessageType, diff: T) {
  return {
    status: messageType,
    diff,
  };
