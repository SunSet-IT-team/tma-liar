  ...
  return (
    <Container className={styles.container}>
      ...
      <div className={styles.taskBlock}>
        ...
        <TextInput placeholder="Task" value='Task' className={styles.taskLoserWrapper} inputClassName={styles.taskLoserInput} />
      </div>
      <Button className={styles.readyBtn} onClick={() => setReady(!ready)}>{ready ? 'Готов' : 'Не готов'}</Button>
    </Container>
  )
}